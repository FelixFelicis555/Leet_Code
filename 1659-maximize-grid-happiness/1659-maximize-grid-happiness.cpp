class Solution {
public:
    int dp[5][7][7][1<<5][1<<5];// dp[row][inc][exc][mask1][mask2]
    // In a given row,in a given cell you can place either  any one of introvert or extorvert ,you don't place either of them
...
// Now, you are placing introvert people in current row at maskx and extrovert people at masky, now check for adjacency among them and among people placed below it and update score accordingly.
    ...
    int getMaxGridHappiness(int m, int n, int introvertsCount, int extrovertsCount) {
        int in=introvertsCount,ex=extrovertsCount;
